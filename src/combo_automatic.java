...
class RandBoard2
{
	...
	{
		num_combos = 0;
		RandBoard2 test_board = new RandBoard2(this);
		test_board.process();
...
public class combo_automatic extends Canvas
{
	...
	{
		combo_automatic graphics = new combo_automatic();
