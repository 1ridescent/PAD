...
class RandBoard4
{
	...
	void get_score()
	{
		num_combos = 0;
		num_colors = 0;
		RandBoard4 test_board = new RandBoard4(this);
		test_board.process();
...
public class ra3_tester extends Canvas
{
	static Scanner sc = new Scanner(System.in);
	static RandBoard4[] list;
	static int[] prev;
	static int next;
	...
	static String path;
	static void add_to_queue(RandBoard4 B, int prev_index)
	{
	...
	static RandBoard4 current_board = new RandBoard4();
	...
	static void run()
	{
				...
				if(color_count[i] == cnt)
				{
					for(int r = 0; r < 5; r++)
						for(int c = 0; c < 6; c++)
						{
							...
							{
								RandBoard4 B = new RandBoard4(current_board);
								B.cur_r = r;
								B.cur_c = c;
								add_to_queue(B, -1);
							}
		...
		for(int iter = 0; iter < num_iterations; iter++)
		{
			...
			{
				RandBoard4 B = new RandBoard4(list[board_index]);
				B.move(-1, 0);
	...
	{
		ra3_tester graphics = new ra3_tester();
	...
	void display(Graphics G, RandBoard4 B)
	{
		for(int r = 0; r < 5; r++)
			for(int c = 0; c < 6; c++)
			{
	...
	public void paint(Graphics G)
	{
		while(true)
		{
			...
			current_board = new RandBoard4(B);
